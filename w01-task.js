...
function total(...theNumbers) { //... is called the spread operator in JS. It is used for
	//spreading elements in an array or object literal and collecting elements into an array or object
	let sum = 0;
